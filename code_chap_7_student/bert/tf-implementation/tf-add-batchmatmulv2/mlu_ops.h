...
struct MLUBatchMatMulV2OpParam {
  ...
  int n_;
  int k_;
  MLUBatchMatMulV2OpParam(float scale_0, int pos_0,
                        float scale_1, int pos_1,
                        int dim_0, int dim_1,
                        int m, int n, int k)
    : scale_0_(scale_0), pos_0_(pos_0), scale_1_(scale_1), pos_1_(pos_1),
      dim_0_(dim_0), dim_1_(dim_1), m_(m), n_(n), k_(k) {}
};
